    ...
    return (
        <div className="sign-up-wrap"><img src={logo} alt="" />
            <div className="w-form">
                ...
                <form id="email-form" name="email-form" data-name="Email Form" className="form" autoComplete="off"><input type="email" className="text_field" maxLength={256} name="email" data-name="Email"
