// generate a react component that is the header for my website
// the header should include a logo, links for the home page, routing page,  and // instruction page. 
// style the react component with tailwind css
